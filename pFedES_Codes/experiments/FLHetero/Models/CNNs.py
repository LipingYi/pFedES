...
class Generator(nn.Module):
    def __init__(self, in_channels=3, n_kernels=8, out_channels=3):
        super(Generator, self).__init__()

        self.conv1 = nn.Conv2d(in_channels, n_kernels, 3, padding='same') # do not change the img size
        self.conv2 = nn.Conv2d(n_kernels, out_channels, 3, padding='same')
